          ...
          <div className={styles.statCards.card}>
            <div className={styles.statCards.cardHeader}>
              ...
              <div className={styles.statCards.iconContainer('orange')}>
                <IndianRupee className={styles.statCards.icon("orange")} />
              </div>
            </div>
            <p className={styles.statCards.cardFooter}>
                  ...
                  return (
                    <div key={transaction.id} className={styles.transactions.transactionItem}>
                      <div className=' flex items-center gap-1 md:gap-4 lg:gap-3'>
                        <div className={`p-2 rounded-lg ${styles.colors.transaction.bg(transaction.type)}`}>
                      ...
                      <span className={styles.colors.transaction.text(transaction.type)}>
