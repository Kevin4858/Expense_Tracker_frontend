...
const Dashboard = () => {
  ...
  // build server-proivided recent list
    ...
    <div className={dashboardStyles.container}>
      ...
      <div className={dashboardStyles.summaryGrid}>
        ...
        <FinancialCard icon={
          ...
          additionalContent={
            <div className={`mt-2 text-xs items-center gap-1 ${expenseChange >= 0 ? trendStyles.positive : trendStyles.negative}`}
            >
              {expenseChange >= 0 ? (
          ...
          additionalContent={
            <div className='mt-2 text-xs text-cyan-600 flex items-center gap-2'>
              ...
              {typeof overviewMeta.savingsRate === "number" && (
                <span className={`px-2 py-1 rounded-xs font-medium ${overviewMeta.savingsRate < 0
      ...
      <div className={dashboardStyles.gaugeGrid}>
        {gaugeData.map((gauge) => (
          <GaugeCard
            ...
            timeFrame={timeFrameRange.label}
          />
        ))}
      </div>
